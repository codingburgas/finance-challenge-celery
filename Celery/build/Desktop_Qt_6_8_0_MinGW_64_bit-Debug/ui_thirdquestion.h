...
"font-size: 30px;\n"
"font: bold;"));
        nameAnswerr = new QLineEdit(thirdQuestion);
        nameAnswerr->setObjectName("nameAnswerr");
        nameAnswerr->setGeometry(QRect(478, 359, 573, 82));
        nameAnswerr->setStyleSheet(QString::fromUtf8("background-color: rgb(51, 51, 51);\n"
"border-radius: 11px;\n"
" padding: 10px ;\n"
"color: white;\n"
"font-size: 50px;\n"
