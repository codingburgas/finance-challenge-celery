...
public:
    ...
    void setupUi(QDialog *dashboard_newBudget)
    {
        ...
        backgroundd->setGeometry(QRect(30, 0, 1500, 775));
...
"weight: 500;\n"
""));
        newBudgetText->setTextFormat(Qt::TextFormat::RichText);
...
""));
        ...
        writeCurrentBudget->setGeometry(QRect(610, 270, 285, 67));
...
"padding: 0 20;"));
        ...
        howmuchText->setGeometry(QRect(610, 350, 225, 29));
...
"padding: 0 20;"));
        ...
        doneButton->setGeometry(QRect(620, 620, 322, 86));
